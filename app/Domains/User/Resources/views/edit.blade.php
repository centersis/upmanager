        ...
        <ol class="flex items-center space-x-4">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-4 text-sm font-medium text-gray-500">Editar {{ $user->name }}</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Atualize as informações de {{ $user->name }}.</p>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('users.update', $user) }}" class="p-6 space-y-6" novalidate>
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                <h4 class="text-sm font-medium text-gray-900 mb-2">Informações do Usuário</h4>
