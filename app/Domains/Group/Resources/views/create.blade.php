...
@section('title', 'Novo Grupo - UPMANAGER')
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <ol class="flex items-center space-x-4">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-4 text-sm font-medium text-gray-500">Novo Grupo</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-600">Preencha as informações do grupo de projetos</p>
        </div>
        
        <form action="{{ route('groups.store') }}" method="POST" class="px-6 py-6 space-y-6">
            @csrf
