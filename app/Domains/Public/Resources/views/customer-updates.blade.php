...
@section('title', $customer->name . ' - ' . __('public.updates_title') . ' - UPMANAGER')
...
<div class="mb-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="mt-2 flex items-center space-x-4">
                        ...
                        <span class="text-sm text-gray-600">
                            {{ $projects->count() }} {{ $projects->count() === 1 ? __('public.project_singular') : __('public.project_plural') }}
                        </span>
                    </div>
                </div>
                <div class="text-right">
                    <div class="text-sm text-gray-500">{{ __('public.customer_portal') }}</div>
    ...
    <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-8">
        <h3 class="text-sm font-medium text-green-900 mb-2">{{ __('public.client_projects') }}</h3>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <div class="text-xs text-green-600 mt-1">
                                {{ $project->updates->where('status', 'published')->count() }} {{ __('public.update_plural') }}
                            </div>
                        </div>
                    </div>
            ...
            <div class="p-6">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <!-- Project Badge -->
                        <div class="mb-3">
                            <a href="{{ public_project_link($update->project->hash) }}" 
...
@else
    <div class="text-center py-12">
        ...
        <p class="mt-1 text-sm text-gray-500">{{ __('public.no_client_updates') }}</p>
    </div>
@endif
