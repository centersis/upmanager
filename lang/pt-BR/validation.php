...
return [
    ...
    | classe validador. Algumas dessas regras têm várias versões como as regras
    ...
    */
    ...
    | usando a convenção "rule.attribute" para nomear as linhas. Isso torna rápido
    | especificar uma linha de linguagem customizada específica para uma regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de linguagem a seguir são usadas para trocar nosso marcador de atributo
